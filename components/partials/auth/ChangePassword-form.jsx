...
const ChangePasswordForm = () => {
  ...
  const validateForm = () => {
    ...
    if (!form.newPassword) errors.newPassword = "Nouveau mot de passe est requis";
    if (!form.confirm) errors.confirm = "Confirmation du mot de passe est requise";
    if (form.newPassword !== form.confirm) errors.confirm = "Les mots de passe ne correspondent pas";
  ...
  const onSubmit = (e) => {
    ...
    AuthService.updatePassword(data)
      .then((res) => {
        toast.success("Votre mot de passe a été changé avec succès. Vous serez redirigé(e).", {
          position: "top-right",
          autoClose: 3000,
